...
/**
 * Class PostRecruitmentArgumentResolverTest.
 */
class PostRecruitmentArgumentResolverTest extends BaseTestCase
{
    ...
    public function testResolveValidRequest(): void
    {
        ...
        $this->assertEquals(['data' => 'form'], $request->current()->getForm());
